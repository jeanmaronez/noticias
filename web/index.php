...
final class Index {
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'NoticiaDao' => '../dao/NoticiaDao.php',
            'NoticiaMapper' => '../mapping/NoticiaMapper.php',
            'Noticia' => '../model/Noticia.php',
            'NoticiaSearchCriteria' => '../dao/NoticiaSearchCriteria.php',
            'NoticiaValidator' => '../validation/NoticiaValidator.php',
    ...
    private function checkPage($page) {
        if (!preg_match('/^[a-z0-9-]+$/i', $page)) {
            // NOTICIA log attempt, redirect attacker, ...
